...
namespace DotNetNote.Controllers
{
    ...
    public class BoardSummaryRepository
    {
        ...
        {
            // 인 메모리 데이터버에스 => 실제 데이터베이스
            var lists = new List<BoardSummaryModel>() {
                new BoardSummaryModel { Id = 1, Alias = "Notice", Name = "홍길동", Title = "공지사항입니다.", PostDate = DateTime.Now },
                new BoardSummaryModel { Id = 2, Alias = "Free", Name = "백두산", Title = "자유게시판입니다.", PostDate = DateTime.Now },
                new BoardSummaryModel { Id = 3, Alias = "Photo", Name = "임꺽정", Title = "사진게시판입니다.", PostDate = DateTime.Now },
                new BoardSummaryModel { Id = 4, Alias = "Notice", Name = "홍길동", Title = "공지사항입니다.", PostDate = DateTime.Now },
            };
